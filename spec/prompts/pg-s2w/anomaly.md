...
# AnomalyFlag
signature: observation, self_model -> anomaly: bool, clause: str

Flag an observation only when it contradicts a cited self-model or safety clause.
Cite the clause id. Do not act. Do not diagnose. Anomaly is a boolean and a citation.

Output: { "flag": null | { "id": string, "clause": string, "severity": "low"|"high" } }
