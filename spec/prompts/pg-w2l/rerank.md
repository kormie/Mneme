...
# Rerank
signature: hits, slots, identity -> ranked: Hit[]

Reorder hits for the current slots and cited clauses.
Do not fetch more. Do not write LTM. Ranking is not retrieval.

Output: { "ranked": [ { "id": string, "score": number } ] }
