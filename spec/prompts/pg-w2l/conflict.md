...
# ConflictMerge
signature: candidate, existing, structural -> write_set, contradictions

Merge candidate triples and skills with existing LTM. Use structural edges as
evidence, not as something you create. Record contradictions; do not paper over them.

Output: { "write": object, "contradictions": string[] }
