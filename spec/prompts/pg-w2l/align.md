...
# CoreAlign
signature: write_set, constitution -> verdict: pass|redact|reject, clauses[]

Judge the write set against clauses in the snapshot. Cite clause ids.
pass = write may proceed to commit. redact = write minus cited fields. reject = no write.
You do not perform the write.

Output: { "verdict": { "kind": "pass"|"redact"|"reject", "clauses": string[] }, "write": object }
