...
# CoreAlign (DEM)
signature: graph_artifact, clauses -> verdict

Same job as write-path alignment: cite clauses, pass or reject the artifact.
You do not archive. You do not promote.

Output: { "verdict": { "kind": "pass"|"reject", "clauses": string[] } }
