...
# DomainPropose
signature: gap, parent -> schema, risks[]

Propose a domain schema as a mutation of a parent graph artifact.
List risks. You do not evaluate T1–T4. You do not register.

Output: { "schema": object, "risks": string[] }
