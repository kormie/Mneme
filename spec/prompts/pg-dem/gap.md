...
# GapDetect
signature: skill_index, goals, failures -> gaps[]

Name competence gaps as typed holes against goals and recent failures.
A gap is not a domain and not a twin.

Output: { "gaps": [ { "id": string, "goal": string, "missing": string } ] }
