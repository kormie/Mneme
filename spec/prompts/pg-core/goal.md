...
# GoalReconcile
signature: task_goal, long_horizon -> binding, tension?

Bind a task goal to long-horizon goals in the snapshot. Report tension; do not
resolve it by dropping a long-horizon goal.

Output: { "binding": { "task": string, "horizon": string[] }, "tension": string | null }
